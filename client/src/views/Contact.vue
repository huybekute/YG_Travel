    ...
    <div class="mx-auto p-6 md:p-12 font-sans text-gray-800">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 bg-white shadow-lg rounded-2xl overflow-hidden mb-10 max-w-7xl mx-auto">
            ...
            <div class="p-8">
                ...
                <div>
                    <input type="text" placeholder="Họ & tên" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 outline-none" required />
                </div>
                <div>
                    <input type="tel" placeholder="Số điện thoại" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 outline-none" required />
                </div>
                <div>
                    <input type="email" placeholder="Địa chỉ email" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 outline-none" required />
                </div>
                <div>
                    <textarea placeholder="Tin nhắn" rows="4" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 outline-none resize-none"></textarea>
                </div>
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg flex items-center gap-2 transition-all shadow-md active:scale-95">
        ...
        <div class="w-full h-[450px] rounded-2xl overflow-hidden shadow-inner border border-gray-200">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3596.4962259553704!2d105.7647611101187!3d10.014261772748842!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a08833003c9e65%3A0x8d2b098fb4d8af01!2zMjE2IFThuqdtIFZ1LCBIxrBuZyBM4bujaSwgTmluaCBLaeG7gXUsIEPhuqduIFRoxqEsIFZp4buHdCBOYW0!5e1!3m2!1svi!2s!4v1773234980528!5m2!1svi!2s" 
